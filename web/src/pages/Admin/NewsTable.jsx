...
import { Box, IconButton, Tooltip, useTheme, Dialog, DialogActions, DialogContent, DialogTitle, Button } from "@mui/material";
...
const NewsTable = () => {
  ...
  const columns = [
    ...
    { field: "content", headerName: "Descrcription", flex: 1 },
    {
      field: "featured",
      headerName: "Featured",
      flex: 0.7,
