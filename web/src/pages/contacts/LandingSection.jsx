...
const LandingSection = () => {
  const handleContactClick = (type) => {
    switch (type) {
      case "email":
        window.open("mailto:ambispinetechnologies@gmail.com", "_blank");
        break;
      case "phone":
  ...
  return (
    <div className="landing-container">
      ...
      <div className="contact-icon email" onClick={() => handleContactClick("email")}>
        <span className="icon">@</span>
        <span>Email</span>
      </div>
      <div className="contact-icon phone" onClick={() => handleContactClick("phone")}>
        <span className="icon">☎</span>
        <span>Phone</span>
      </div>
      <div className="contact-icon chat" onClick={() => handleContactClick("chat")}>
        <span className="icon">💬</span>
        <span>Chat</span>
      </div>
    </div>
