    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section-address">
          ...
          <p>
            <IoLocationSharp className="contact-icon-address" /> Rewa(M.P.),
            India
          </p>
          <p style={{ width: "320px" }}>
            <MdOutlineMailOutline className="contact-icon-address" />
            ambispinetechnologies@gmail.com
          </p>
          <p>
            <IoCallSharp className="contact-icon-address" /> +91 9685221056
          </p>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <p>
          ...
          2024 Copyright: Taken by AmbiSpine Technologies Private Limited
        </p>
