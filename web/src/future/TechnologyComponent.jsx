...
import {
  FaReact, FaAngular, FaNodeJs, FaPython, FaJava, FaJs,
  FaHtml5, FaCss3Alt, FaBootstrap, FaGitAlt, FaDocker, FaAws,
  FaPhp, FaSwift, FaAndroid, FaVuejs, FaSass, FaDatabase,
  FaGithub, FaLinux
} from "react-icons/fa";
...
const TechnologyComponent = () => {
  return (
    <div className="tech-container">
      ...
      <p className="tech-subheading">We specialize in modern frameworks & tools</p>
