    ...
    <div className="soft-custom-service-container">
      <div className="soft-custom-card-left">
        <div className="cms-feature-left-content">
          <h1 className="soft-custom-heading">
            Custom Software Development Services{" "}
          </h1>
          <p className="soft-custom-subtile">
            We build tailored software solutions to meet your unique business
            needs, delivering the highest growth potential
          </p>
        </div>
      </div>
