...
export default function SpreadFourthSection({heading, maintext, title, img1, img2, order1 , order2 }) {
  return (
    <div>
           <div className="spread-fourth-section">
                <div className={`spread-fourth-section-left ${order1 || ''}`}>
                    <h1 className="spread-second-section-hader">{heading}<span className="spread-text">{maintext}</span> ads</h1>
