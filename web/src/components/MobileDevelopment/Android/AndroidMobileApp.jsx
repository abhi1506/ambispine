  ...
  const androidMobileApp = [
    {
      ...
      description: "We create bespoke Android applications tailored to meet your business needs and user expectations.",
      className: "custom-android-services",
    },
    {
      id: 2,
      heading: "App Consulting",
      description: "Our expert consultants help you define your Android app requirements, identify target audiences, and determine the best features and functionalities.",
      className: "android-app-consulting",
    },
    {
      id: 3,
      heading: "App UI/UX Design",
      description: "Our skilled designers craft intuitive and engaging Android app interfaces that enhance user experience and brand visibility.",
      className: "android-app-design",
    },
    {
      id: 4,
      heading: "App Testing & Quality Assurance",
      description: "We conduct rigorous testing to ensure your Android app is secure, bug-free, and provides a seamless experience across devices.",
  ...
  const whyChooseAndroid = [
    {
      ...
      description: "Our Android development team has extensive experience in building scalable, high-performance applications.",
      className: "expert-android-team",
    },
    {
      id: 2,
      heading: "Agile Development Process",
      description: "We follow an agile methodology to ensure timely delivery and efficient updates based on your evolving needs.",
      className: "android-agile-methodology",
    },
    {
      id: 3,
      heading: "User-Centric Design",
      description: "We focus on user experience, ensuring intuitive navigation, accessibility, and visual appeal in every app we build.",
      className: "android-user-centric",
    },
    {
      id: 4,
      heading: "Affordable Solutions",
      description: "We offer cost-effective Android app development solutions without compromising on quality or performance.",
  ...
  const faqs = [
    {
      ...
      answer: "Yes. The first task of our team is to sign an NDA to maintain the app's security and privacy. You can trust us that your Android app development ideas will be completely safe.",
    },
    {
