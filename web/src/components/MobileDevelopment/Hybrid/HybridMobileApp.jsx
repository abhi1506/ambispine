  ...
  const comprehensivedata = [
    {
      ...
      description: "We create seamless hybrid apps that work across both iOS and Android platforms, providing a cost-effective solution for businesses.",
      className: "hybrid-mobile-development",
    },
    {
      id: 2,
      heading: "Cross-Platform Compatibility",
      description: "Our hybrid apps ensure smooth performance across multiple devices while maintaining a native-like experience.",
      className: "cross-platform-compatibility",
    },
    {
      id: 3,
      heading: "Performance Optimization",
      description: "We optimize hybrid apps for speed and efficiency, ensuring a seamless user experience with fast load times and responsiveness.",
      className: "performance-optimization",
    },
    {
      id: 4,
      heading: "App Testing & Quality Assurance",
      description: "We conduct rigorous testing to ensure your hybrid app meets high performance, usability, and security standards.",
  ...
  const whychoose = [
    {
      ...
      description: "Our team has extensive experience in hybrid app development using technologies like React Native, Flutter, and Ionic.",
      className: "expert-hybrid-developers",
    },
    {
      id: 2,
      heading: "Cost-Effective Solutions",
      description: "We provide budget-friendly hybrid app development services, ensuring maximum ROI with minimal costs.",
      className: "cost-effective-solutions",
    },
    {
      id: 3,
      heading: "Faster Development Time",
      description: "Hybrid apps allow for quicker development and deployment, reducing time-to-market for your application.",
      className: "faster-development-time",
    },
    {
      id: 4,
      heading: "Seamless Maintenance & Updates",
      description: "Easily maintain and update your hybrid apps with a single codebase for both iOS and Android platforms.",
