  ...
  const comprehensivedata = [
    {
      ...
      description: "We develop tailor-made iOS applications that align with your business goals and enhance user engagement.",
      className: "custom-iphone-services",
    },
    {
      id: 2,
      heading: "App Consulting",
      description: "Our expert consultants help you define app requirements, identify target audiences, and determine the best features and functionalities for optimal success.",
      className: "app-consulting",
    },
    {
      id: 3,
      heading: "App Design",
      description: "Our skilled designers create visually stunning, user-friendly interfaces that reflect your brand and captivate users.",
      className: "app-design",
    },
    {
      id: 4,
      heading: "App Testing & Quality Assurance",
      description: "We ensure your app meets the highest quality standards through rigorous testing, enhancing performance and reliability.",
  ...
  const whychoose = [
    {
      id: 1,
      heading: "Expert Team",
      description: "Our experienced iPhone app development team delivers high-quality solutions that exceed expectations.",
      className: "expert-team",
    },
    {
      id: 2,
      heading: "Agile Methodology",
      description: "We follow an agile development approach to ensure flexibility, faster iterations, and seamless project execution.",
      className: "agile-methodology",
    },
    {
      id: 3,
      heading: "Customer-Centric Approach",
      description: "We prioritize your business needs, offering tailored solutions that enhance user satisfaction and engagement.",
      className: "customer-centric-approach",
    },
    {
      id: 4,
      heading: "Cost-Effective Solutions",
      description: "We optimize resources and streamline processes to deliver high-quality apps within your budget.",
