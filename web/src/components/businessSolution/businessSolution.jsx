      ...
      keyPoints: [
        {
          ...
          description:
            "Establish a clear vision and strategy and boost your business capability with technology roadmapping.",
          icon: FaArrowDown,
        },
        {
          title: "Cloud Migration Strategies",
          description:
            "A well-planned cloud migration strategy can help you to improve your business agility and responsiveness",
          icon: FaArrowDown,
        },
        {
          title: "AI & Machine Learning Integration",
          description:
            "Operate your business and make more efficient, agile and innovative, Automate repetitive task and processes.",
          icon: FaArrowDown,
        },
        {
          title: "Cybersecurity Enhancement",
          description:
            "Protect your business from evolving cyber threats wit a robust cybersecurity strategy. Enhance your cybersecurity posture and ensure business continuity.",
          icon: FaArrowDown,
        },
        {
          title: "Data-Driven Decision Making",
          description:
            "Improve accuracy, increase efficiency and enhanced customer experiences and drive business success .",
          icon: FaArrowDown,
        },
        {
          title: "Digital Customer Experience",
          description:
            "Join the digital age with a well-designed digital customer experience. Drive business success through personalized, intuitive, and seamless experience.",
          icon: FaArrowDown,
        },
      ],
    },
      ...
      keyPoints: [
        {
          ...
          description:
            "It involves analyzing various market and customer-related factors to determine the company's strengths, weaknesses, opportunities, and threats.",
          icon: FaArrowDown,
        },
        {
          title: "Growth Strategy Development",
          description:
            "Increase revenue with clear direction and improve competitiveness. Develop strategy to improve the growth with cloud migration strategies. ",
          icon: FaArrowDown,
        },
        {
          title: "Organizational Transformation",
          description:
            "Unlock sustainable success through organizational transformation. Develop leaders, improve processes, and adopt technology to drive innovation and efficiency.",
          icon: FaArrowDown,
        },
        {
          title: "Performance Optimization",
          description:
            "Give a peak performance in your organization with performance optimization. Eliminate inefficiencies, drive growth, innovation, and sustainability with a comprehensive optimization strategy.",
          icon: FaArrowDown,
        },
        {
          title: "Competitive Intelligence",
          description:
            "Stay ahead of the competition with actionable insights from competitive intelligence. Gather, analyze, and disseminate information to drive business success.",
          icon: FaArrowDown,
        },
        {
          title: "Change Management",
          description:
            "Navigate organizational change with ease using effective change management strategies. Minimize resistance to change and ensure a smooth transition with our expert guidance.",
          icon: FaArrowDown,
        },
      ],
    },
      ...
      keyPoints: [
        {
          ...
          description:
            "Innovation culture design involves creating an environment that fosters creativity, experimentation, and risk-taking to drive innovation and growth.",
          icon: FaArrowDown,
        },
        {
          title: "Technology Scouting",
          description:
            "Technology scouting involves identifying and leveraging emerging technologies to drive innovation and stay ahead of the competition.",
          icon: FaArrowDown,
        },
        {
          title: "Startup Ecosystem Engagement",
          description:
            "Startup ecosystem engagement involves collaborating with startups to access innovative solutions and talent, and to drive growth and innovation.",
          icon: FaArrowDown,
        },
        {
          title: "R&D Strategy Alignment",
          description:
            "R&D strategy alignment involves aligning R&D strategies with business objectives to drive innovation and growth, and to maximize ROI.",
          icon: FaArrowDown,
        },
        {
          title: "Innovation Portfolio Management",
          description:
            "Innovation portfolio management involves managing innovation portfolios to maximize ROI and minimize risk, and to drive growth and innovation.",
          icon: FaArrowDown,
        },
        {
          title: "Emerging Technology Integration",
          description:
            "Emerging technology integration involves integrating emerging technologies into business operations to drive innovation and growth, and to stay ahead of the competition.",
          icon: FaArrowDown,
        },
      ],
    },
  ...
  const expetSoftware = [
    {
      ...
      description:
        "Optimize your enterprise architecture for digital transformation.",
      icon: PiBankLight,
    },
    {
      title: "CRM Software",
        ...
        <div className="expert-service-grid">
          {expetSoftware.map((advantage, index) => (
            <div key={index} className="expert-service-card">
              <div className="advantage-icon fs-1">
                <advantage.icon className="expert-software-icon" />
              </div>
