...
// import ExploreHeroTechnologi from '../ExploreTechnologie/ExploreHereSection';
    ...
    <div className="digital-market-update">
      <div className="here-section-digital">
        <ExploreHeroTechnologi
          heading="Developing a Digital Marketing Plan: See the Magic!"
          subtitle="Digital marketing refers to the promotion of products, brands, or services using digital channels. The goal of digital marketing is to reach and engage with target audiences, drive traffic, generate leads, and ultimately convert them into customers."
          className="  "
      ...
      <div className="Clicks-to-Conversion-Container">
        ...
        <div className="clicks-conversion-right">
