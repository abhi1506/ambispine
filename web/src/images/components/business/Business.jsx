...
const BusinessLanding = () => {
  ...
  return (
    <div className="landing-container">
      ...
      {/* <div className="hero-container-busines">
        <div className="content-section-busines">
          <h1 className="title-busines">Business Solution</h1>
          <p className="description-busines">
            Start Designs is an emerging web development company that offers
            website development services. Our in-house team and professional web
            developers uses new technologies.
          </p>
        ...
        <div className="image-section-busines">
          <img
            src={businessImage}
